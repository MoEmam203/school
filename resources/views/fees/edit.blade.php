...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">{{ __('Fees_trans.editFee') }}</h4>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{ __('mainside.fees') }}</a></li>
                <li class="breadcrumb-item active">{{ __('Fees_trans.editFee') }}</li>
            </ol>
        </div>
    </div>
</div>
                        ...
                        <form action="{{route('fees.update',$fee)}}" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="name_en" class="form-control" value="{{ $fee->getTranslation('name','en') }}">
                                </div>
                                <div class="col">
